...
public class SwitchRoomAdapter extends ArrayAdapter<Switch> {
	ProgressDialog dialog = null;
	Context context;
	int resourceId;
	List<Switch> toShow = null;
	private final static String TAG = ":SwitchRoomAdapter";
	...
	public void setSerialAndId(String gatewaySerial, String floorId,String roomId) {
		this.gatewaySerial = gatewaySerial;
		this.floorId = floorId;
		this.roomId = roomId;
	}

	public SwitchRoomAdapter(Activity context, int resourceId,
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		if (row == null) {
			...
			holder.switchName = (TextView) row.findViewById(R.id.floorRoomName);
			...
			holder.deleteButton.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					roomName.setText(toShow.get(position).getSwitchName());
					Button dialogButton = (Button) dialogRoom
							.findViewById(R.id.dialog_cancel);
					// if button is clicked, close the custom dialog
					dialogButton.setOnClickListener(new OnClickListener() {
	...
	class EditRoom extends AsyncTask<List<NameValuePair>, String, String> {
		...
		protected String doInBackground(List<NameValuePair>... input) {
			...
			HttpPut request = new HttpPut(Constants.URL_CREATE_GATEWAY + "/"
					...
					+ toShow.get(positionSelected).getSwitchId());
