...
import com.advanchip.mobile_controlledlighting.adapters.TabsPagerAdapter;
...
public class EntryActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(SharedPrefUtils.getLoggedIn(getApplicationContext())){
			Intent resetPasswordIntent = new Intent(EntryActivity.this, MenuActivity.class);
